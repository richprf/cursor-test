      ...
      <Card>
        <div className="mb-6 flex items-center gap-4">
          {session.user.image ? (
            ...
            <div className="grid size-12 place-items-center rounded-full bg-indigo-600/10 text-lg font-semibold text-indigo-600">
        ...
        <p className="mt-5 text-xs leading-6 text-muted">
          این اطلاعات از مسیر محافظت‌شدهٔ <code dir="ltr">GET /auth/me</code> و با هدر{' '}
          <code dir="ltr">Authorization: Bearer …</code> از NestJS خوانده شده است.
        </p>
